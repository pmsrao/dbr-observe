    ...
    def _ingest_billing_list_prices(self) -> bool:
        ...
        try:
            ...
            prices_bronze = prices_source.select(
                ...
                col("price_start_time").cast("date").alias("effective_date"),
                current_timestamp().alias("ingestion_timestamp"),
        ...
        try:
            ...
            query_bronze = query_source.select(
                struct(
                    ...
                    col("statement_type").alias("statement_type"),
                    ...
                    col("executed_as_user_id").alias("executed_as_user_id"),
                    col("start_time").alias("start_time"),
                    col("end_time").alias("end_time"),
                    col("total_duration_ms").alias("total_duration_ms"),
                    col("waiting_for_compute_duration_ms").alias("waiting_for_compute_duration_ms"),
                    col("waiting_at_capacity_duration_ms").alias("waiting_at_capacity_duration_ms"),
                    col("execution_duration_ms").alias("execution_duration_ms"),
                    col("compilation_duration_ms").alias("compilation_duration_ms"),
                    col("total_task_duration_ms").alias("total_task_duration_ms"),
                    col("result_fetch_duration_ms").alias("result_fetch_duration_ms"),
                    col("read_partitions").alias("read_partitions"),
                    col("pruned_files").alias("pruned_files"),
                    col("read_files").alias("read_files"),
                    col("read_rows").alias("read_rows"),
                    col("produced_rows").alias("produced_rows"),
                    col("read_bytes").alias("read_bytes"),
                    col("read_io_cache_percent").alias("read_io_cache_percent"),
                    col("spilled_local_bytes").alias("spilled_local_bytes"),
                    col("written_bytes").alias("written_bytes"),
                    col("written_rows").alias("written_rows"),
                    col("written_files").alias("written_files"),
                    col("shuffle_read_bytes").alias("shuffle_read_bytes"),
                    col("from_result_cache").alias("from_result_cache"),
                    col("cache_origin_statement_id").alias("cache_origin_statement_id"),
                    col("client_application").alias("client_application"),
                    col("client_driver").alias("client_driver"),
                    col("query_source").alias("query_source"),
                    col("query_parameters").alias("query_parameters")
                ).alias("raw_data"),
                col("workspace_id"),
                col("start_time"),
                col("start_time").cast("date").alias("start_date"),
                current_timestamp().alias("ingestion_timestamp"),
